...
def main() -> None:
    ...
    print("  ! Honest, leakage-free out-of-sample numbers come from v3.1:        !")
    print("  !   python scripts/v3_run.py                                        !")
    print("  ! On real data v3.1 reports PR-AUC ~ 0.10-0.17, Brier skill ~ +0.02 !")
    print("  ! (positive, beats climatology) for the un-weighted linear models,  !")
    print("  ! and no model beats the VIX-threshold baseline (0.169). The full   !")
    print("  ! results are committed in outputs/v3_metrics.json.                 !")
    print("  " + "!" * 66)
